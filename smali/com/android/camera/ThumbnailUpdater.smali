...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    invoke-direct {p1, v0, p0}, Lcom/android/camera/ThumbnailUpdater$a;-><init>(Landroid/os/Handler;Ld/c/a/e5;)V
    ...
    invoke-direct {p1, v0, p0}, Lcom/android/camera/ThumbnailUpdater$b;-><init>(Landroid/os/Handler;Ld/c/a/e5;)V
    ...
    new-instance v0, Ld/c/a/b2;

    invoke-direct {v0, p0}, Ld/c/a/b2;-><init>(Lcom/android/camera/ThumbnailUpdater;)V
...
.method public static synthetic b(Lcom/android/camera/ThumbnailUpdater;Ld/c/a/c5;ZZZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->x(Ld/c/a/c5;ZZZ)V
...
.method public static synthetic d(Landroid/net/Uri;Z)J
    ...
    invoke-static {p0, p1}, Lcom/android/camera/ThumbnailUpdater;->u(Landroid/net/Uri;Z)J
...
.method private static g(Z)Landroid/net/Uri;
    ...
    invoke-static {v3}, Ld/c/a/g6/a/b/a;->k(Landroid/content/Context;)Ljava/lang/String;
...
.method private synthetic q(ZIZLd/c/a/r6/g/d;)V
    .locals 1

    invoke-interface {p4}, Ld/c/a/r6/g/d;->canProvide()Z
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/c5;

    invoke-interface {p4, p0, p1, p2, p3}, Ld/c/a/r6/g/d;->updateThumbnail(Ld/c/a/c5;ZIZ)V

    return-void
.end method

.method private synthetic s(ZIZ)V
    .locals 2
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Ld/c/a/c2;-><init>(Lcom/android/camera/ThumbnailUpdater;ZIZ)V
...
.method private static u(Landroid/net/Uri;Z)J
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method private x(Ld/c/a/c5;ZZZ)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/c5;

    if-eqz p2, :cond_0

    invoke-virtual {p0, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->z(ZZ)V
...
.method public f()V
    ...
    new-instance v1, Ld/c/a/z1;

    invoke-direct {v1, p0}, Ld/c/a/z1;-><init>(Lcom/android/camera/ThumbnailUpdater;)V
...
.method public h()V
    ...
    iget-object v5, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/c5;

    invoke-direct {v1, v3, v4, p0, v5}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Ld/c/a/c5;)V
...
.method public i(Z)V
    ...
    iget-object v8, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/c5;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Ld/c/a/c5;)V
...
.method public synthetic r(ZIZLd/c/a/r6/g/d;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->q(ZIZLd/c/a/r6/g/d;)V

    return-void
.end method

.method public synthetic t(ZIZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/ThumbnailUpdater;->s(ZIZ)V
...
.method public v()V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/c5;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Ld/c/a/c5;->m()Z
...
.method public w(Ld/c/a/c5;ZZ)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/android/camera/ThumbnailUpdater;->x(Ld/c/a/c5;ZZZ)V
...
.method public z(ZZ)V
    ...
    new-instance v2, Ld/c/a/a2;

    invoke-direct {v2, p0, p1, v0, p2}, Ld/c/a/a2;-><init>(Lcom/android/camera/ThumbnailUpdater;ZIZ)V
