...
.method public constructor <init>(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaControllerCompat$a$a;->n:Landroid/support/v4/media/session/MediaControllerCompat$a;

    invoke-direct {p0, p2}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V

    const/4 p1, 0x0

    iput-boolean p1, p0, Landroid/support/v4/media/session/MediaControllerCompat$a$a;->m:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-boolean v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$a$a;->m:Z
    ...
    :pswitch_1
    iget-object p0, p0, Landroid/support/v4/media/session/MediaControllerCompat$a$a;->n:Landroid/support/v4/media/session/MediaControllerCompat$a;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$a;->b(Landroid/support/v4/media/session/MediaControllerCompat$g;)V
