...
.method public reportError([Lj/f/c;Ljava/lang/Throwable;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    invoke-static {p2, v1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lj/f/c;)V
...
.method public subscribe([Lj/f/c;)V
    ...
    invoke-direct {v4, v5, v3, v6}, Lio/reactivex/internal/operators/parallel/ParallelCollect$ParallelCollectSubscriber;-><init>(Lj/f/c;Ljava/lang/Object;Lio/reactivex/functions/BiConsumer;)V
    ...
    invoke-virtual {p0, p1, v0}, Lio/reactivex/internal/operators/parallel/ParallelCollect;->reportError([Lj/f/c;Ljava/lang/Throwable;)V
