...
.method public drainNormal()V
    ...
    :goto_2
    invoke-virtual {p0, v12, v14, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLj/f/c;Z)Z
    ...
    :cond_3
    invoke-interface {v2, v13}, Lj/f/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v11, v12, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLj/f/c;Z)Z
    ...
    iget-object v5, v5, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lj/f/d;

    invoke-interface {v5, v9, v10}, Lj/f/d;->request(J)V
