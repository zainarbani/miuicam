...
.method public constructor <init>(Lj/f/c;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;IZ)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->actual:Lj/f/c;
...
.method public cancel()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lj/f/d;
...
.method public cancel(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lj/f/d;
...
.method public checkTerminated(ZZLj/f/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p3, p0}, Lj/f/c;->onError(Ljava/lang/Throwable;)V
...
.method public drainFused()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->actual:Lj/f/c;
    ...
    invoke-interface {v1, v4}, Lj/f/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v4}, Lj/f/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v1, p0}, Lj/f/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_3
    invoke-interface {v1}, Lj/f/c;->onComplete()V
...
.method public drainNormal()V
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLj/f/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_3
    invoke-interface {v1, v12}, Lj/f/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v10, v11, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLj/f/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_6
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lj/f/d;

    invoke-interface {v4, v8, v9}, Lj/f/d;->request(J)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lj/f/d;
...
.method public onSubscribe(Lj/f/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lj/f/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->actual:Lj/f/c;
