...
# direct methods
.method public constructor <init>(Lj/f/c;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;IJZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public drainLoop()V
    ...
    iget-object v2, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lj/f/c;
    ...
    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->s:Lj/f/d;
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->s:Lj/f/d;
    ...
    invoke-interface {v2, v1}, Lj/f/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v6, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lj/f/c;

    invoke-interface {v6, v5}, Lj/f/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lj/f/c;
    ...
    invoke-interface {v1, v2}, Lj/f/c;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->s:Lj/f/d;

    invoke-interface {p1}, Lj/f/d;->cancel()V

    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lj/f/c;
    ...
    invoke-interface {p1, v0}, Lj/f/c;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Lj/f/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->s:Lj/f/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->s:Lj/f/d;
    ...
    invoke-interface {v0, v1}, Lj/f/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0}, Lj/f/c;->onError(Ljava/lang/Throwable;)V
