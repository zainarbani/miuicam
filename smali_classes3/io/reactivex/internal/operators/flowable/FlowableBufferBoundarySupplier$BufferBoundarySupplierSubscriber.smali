...
# direct methods
.method public constructor <init>(Lj/f/c;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Lj/f/c;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
...
# virtual methods
.method public bridge synthetic accept(Lj/f/c;Ljava/lang/Object;)Z
    .locals 0

    check-cast p2, Ljava/util/Collection;

    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->accept(Lj/f/c;Ljava/util/Collection;)Z
...
.method public accept(Lj/f/c;Ljava/util/Collection;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lj/f/c;

    invoke-interface {p0, p2}, Lj/f/c;->onNext(Ljava/lang/Object;)V
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lj/f/d;
...
.method public next()V
    ...
    invoke-interface {v1, v2}, Lj/f/b;->subscribe(Lj/f/c;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lj/f/d;

    invoke-interface {v1}, Lj/f/d;->cancel()V
...
.method public onComplete()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lj/f/c;

    const/4 v2, 0x0

    invoke-static {v0, v1, v2, p0, p0}, Lio/reactivex/internal/util/QueueDrainHelper;->drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lj/f/c;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
...
.method public onSubscribe(Lj/f/d;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lj/f/d;

    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lj/f/c;
    ...
    invoke-interface {p1, v3, v4}, Lj/f/d;->request(J)V

    invoke-interface {v2, v1}, Lj/f/b;->subscribe(Lj/f/c;)V
    ...
    invoke-static {v2, v0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lj/f/c;)V
