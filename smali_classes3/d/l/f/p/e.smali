...
.method private b(Ld/l/f/i/p;Ld/l/f/i/p$a;Ld/l/f/p/d;)V
    ...
    invoke-virtual {p1}, Ld/l/f/i/p;->w()Z
...
.method private c(Ld/l/f/i/p;Ljava/util/List;Ld/l/f/p/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p1, p0}, Ld/l/f/i/p;->O(Ld/l/f/i/p$a;)V

    invoke-virtual {p1, p2}, Ld/l/f/i/p;->I(Ljava/util/List;)V
...
.method public a(Ld/l/f/i/p;Ld/l/f/p/d;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-direct/range {v8 .. v13}, Ld/l/f/i/p$a;-><init>(IZLe/c;ZZ)V
    ...
    invoke-static {v9, v5}, Ld/l/f/e/e;->b(Ljava/lang/String;I)V
    ...
    check-cast v15, Ld/l/f/i/p$a;

    invoke-virtual {v15}, Ld/l/f/i/p$a;->i()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v16, Ld/c/b/v5/wo;->V1:Ld/c/b/v5/xo;

    invoke-virtual/range {v16 .. v16}, Ld/c/b/v5/xo;->b()Ljava/lang/Object;
    ...
    invoke-virtual {v15}, Ld/l/f/i/p$a;->f()Landroid/media/Image;
    ...
    invoke-static {v9, v10}, Ld/l/f/e/e;->b(Ljava/lang/String;I)V
    ...
    invoke-static {v9, v8}, Ld/l/f/e/e;->b(Ljava/lang/String;I)V
    ...
    check-cast v20, Ld/l/f/i/p$a;

    invoke-virtual/range {v20 .. v20}, Ld/l/f/i/p$a;->i()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v21, Ld/c/b/v5/wo;->V1:Ld/c/b/v5/xo;

    invoke-virtual/range {v21 .. v21}, Ld/c/b/v5/xo;->b()Ljava/lang/Object;
    ...
    invoke-virtual/range {v20 .. v20}, Ld/l/f/i/p$a;->m()Landroid/media/Image;
    ...
    invoke-virtual {v14, v0, v2, v4}, Ld/l/f/i/p$a;->F(Landroid/media/Image;IZ)V
    ...
    :goto_d
    invoke-virtual {v14, v3, v2}, Ld/l/f/i/p$a;->B(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v1}, Ld/l/f/i/p$a;->o()Landroid/media/Image;

    move-result-object v0

    const/4 v2, 0x2

    invoke-virtual {v1}, Ld/l/f/i/p$a;->z()Z

    move-result v3

    invoke-virtual {v14, v0, v2, v3}, Ld/l/f/i/p$a;->F(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v14, v0, v2, v2}, Ld/l/f/i/p$a;->F(Landroid/media/Image;IZ)V
    ...
    :cond_10
    invoke-virtual {v3}, Ld/l/f/i/p$a;->f()Landroid/media/Image;

    move-result-object v5

    invoke-virtual {v5}, Landroid/media/Image;->close()V

    invoke-interface {v0, v5}, Ld/l/f/i/q;->b(Landroid/media/Image;)V

    invoke-virtual {v3}, Ld/l/f/i/p$a;->m()Landroid/media/Image;
    ...
    :cond_11
    invoke-virtual {v3}, Ld/l/f/i/p$a;->o()Landroid/media/Image;
    ...
    invoke-interface {v0, v1}, Ld/l/f/i/q;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v14, v1, v2, v3}, Ld/l/f/i/p$a;->F(Landroid/media/Image;IZ)V
    ...
    :goto_12
    invoke-virtual {v14}, Ld/l/f/i/p$a;->q()Z
    ...
    invoke-virtual {v1, v3}, Ld/l/f/i/p$a;->H(Z)V
    ...
    invoke-direct {v1, v2, v4, v5}, Ld/l/f/p/e;->c(Ld/l/f/i/p;Ljava/util/List;Ld/l/f/p/d;)V
    ...
    invoke-direct {v1, v2, v14, v5}, Ld/l/f/p/e;->b(Ld/l/f/i/p;Ld/l/f/i/p$a;Ld/l/f/p/d;)V
...
.method public d(II)V
    ...
    iput p1, p0, Ld/l/f/p/e;->b:I

    iput p2, p0, Ld/l/f/p/e;->c:I
