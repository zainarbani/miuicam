...
.method public constructor <init>(Landroid/media/MediaFormat;Landroid/opengl/EGLContext;JJLjava/util/Queue;)V
    ...
    invoke-direct/range {v0 .. v6}, Ld/l/f/m/i/b;-><init>(Landroid/media/MediaFormat;JJLjava/util/Queue;)V

    const/high16 p1, 0x7f800000    # Float.POSITIVE_INFINITY

    iput p1, p0, Ld/l/f/m/i/c;->H:F
    ...
    iget-wide p4, p0, Ld/l/f/m/i/b;->h:J
    ...
    iput-object p2, p0, Ld/l/f/m/i/c;->F:Landroid/opengl/EGLContext;
    ...
    iput-object p1, p0, Ld/l/f/m/i/c;->D:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private declared-synchronized q()V
    ...
    iget-object v0, p0, Ld/l/f/m/i/c;->E:Ld/l/f/m/j/c;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Ld/l/f/m/j/c;->o()V

    const/4 v0, 0x0

    iput-object v0, p0, Ld/l/f/m/i/c;->E:Ld/l/f/m/j/c;
...
.method public declared-synchronized d()V
    ...
    iget-object v1, p0, Ld/l/f/m/i/b;->g:Landroid/media/MediaFormat;
    ...
    iput-object v0, p0, Ld/l/f/m/i/c;->G:Landroid/view/Surface;
    :try_end_1
    .catch Ljava/lang/IllegalStateException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    new-instance v0, Ld/l/f/m/j/c;

    const-string v5, "CircularVideoEncoder"

    iget-object v6, p0, Ld/l/f/m/i/c;->F:Landroid/opengl/EGLContext;

    iget-object v7, p0, Ld/l/f/m/i/c;->G:Landroid/view/Surface;

    iget v8, p0, Ld/l/f/m/i/c;->B:I

    iget v9, p0, Ld/l/f/m/i/c;->C:I

    const/4 v10, 0x1

    move-object v4, v0

    invoke-direct/range {v4 .. v10}, Ld/l/f/m/j/c;-><init>(Ljava/lang/String;Landroid/opengl/EGLContext;Landroid/view/Surface;IIZ)V

    iput-object v0, p0, Ld/l/f/m/i/c;->E:Ld/l/f/m/j/c;

    iget v1, p0, Ld/l/f/m/i/c;->H:F

    invoke-virtual {v0, v1}, Ld/l/f/m/j/c;->q(F)V
    ...
    invoke-virtual {v0}, Ld/l/f/m/j/c;->v()V
    ...
    iput-wide v0, p0, Ld/l/f/m/i/c;->I:J

    iput-wide v0, p0, Ld/l/f/m/i/c;->J:J

    invoke-super {p0}, Ld/l/f/m/i/b;->d()V

    iput-boolean v3, p0, Ld/l/f/m/i/b;->s:Z
...
.method public declared-synchronized e()V
    ...
    :cond_0
    iput-boolean v2, p0, Ld/l/f/m/i/b;->s:Z

    invoke-direct {p0}, Ld/l/f/m/i/c;->q()V

    iget-object v0, p0, Ld/l/f/m/i/c;->G:Landroid/view/Surface;
    ...
    :try_start_3
    invoke-virtual {v1}, Ld/l/f/m/i/b$d;->d()V
    :try_end_3
...
.method public f(J)J
    ...
    iget-wide v0, p0, Ld/l/f/m/i/c;->I:J
    ...
    iput-wide p1, p0, Ld/l/f/m/i/c;->I:J
    ...
    iget-wide v0, p0, Ld/l/f/m/i/c;->J:J
    ...
    :cond_1
    iput-wide p1, p0, Ld/l/f/m/i/c;->J:J
...
.method public m(Z)V
    ...
    invoke-super {p0, p1}, Ld/l/f/m/i/b;->m(Z)V
...
.method public n()V
    ...
    iget-object p0, p0, Ld/l/f/m/i/c;->D:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public declared-synchronized o(Ld/l/f/m/j/c$c;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    :cond_0
    iget-object v0, p0, Ld/l/f/m/i/c;->D:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0}, Ld/l/f/m/j/c;->m()V

    :cond_1
    iget-object v0, p0, Ld/l/f/m/i/c;->E:Ld/l/f/m/j/c;

    invoke-virtual {v0, p1}, Ld/l/f/m/j/c;->k(Ld/l/f/m/j/c$c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
