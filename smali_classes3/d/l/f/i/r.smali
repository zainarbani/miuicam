...
.method public constructor <init>(Ld/l/f/i/v$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Ld/l/f/i/n;-><init>(Ld/l/f/i/v$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    :goto_1
    iput-boolean p1, p0, Ld/l/f/i/r;->W:Z
...
.method private f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-boolean p2, p0, Ld/l/f/i/r;->W:Z
    ...
    sget-object v0, Ld/c/b/v5/wo;->V1:Ld/c/b/v5/xo;
    ...
    :cond_2
    new-instance p1, Ld/l/f/i/r$d;

    invoke-direct {p1, p0}, Ld/l/f/i/r$d;-><init>(Ld/l/f/i/r;)V
    ...
    iget-object p1, p0, Ld/l/f/i/n;->T:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p2, p0, Ld/l/f/i/n;->N:Lcom/xiaomi/engine/TaskSession;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Ld/l/f/i/n;->O:Ld/l/f/i/j0;

    invoke-virtual {p2}, Ld/l/f/i/j0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_4
    new-instance p1, Ld/l/f/i/r$e;

    invoke-direct {p1, p0}, Ld/l/f/i/r$e;-><init>(Ld/l/f/i/r;)V
...
.method private g0(Ld/l/f/i/h0;)V
    .locals 9
    ...
    invoke-virtual {v1}, Ld/l/f/i/p$a;->m()Landroid/media/Image;

    move-result-object v3

    invoke-virtual {p0, v2}, Ld/l/f/i/v;->q(Landroid/media/Image;)Z

    move-result v4

    invoke-virtual {p0, v3}, Ld/l/f/i/v;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v8, v7}, Ld/l/f/e/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v1}, Ld/l/f/i/p$a;->i()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p1}, Ld/l/f/i/h0;->e()I

    move-result v4

    invoke-direct {p0, v1, v2, v7, v4}, Ld/l/f/i/r;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-direct {p0, v1, v3, v2, v4}, Ld/l/f/i/r;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method private h0(Ld/l/f/i/h0;)V
    .locals 7
    .param p1    # Ld/l/f/i/h0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v4, v5}, Ld/l/f/e/e;->b(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v1, v2, v5, v4}, Ld/l/f/i/r;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public X(Ld/l/f/i/h0;)V
    ...
    invoke-virtual {p1}, Ld/l/f/i/h0;->f()Le/c;
    ...
    :cond_1
    invoke-direct {p0, p1}, Ld/l/f/i/r;->g0(Ld/l/f/i/h0;)V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-direct {p0, p1}, Ld/l/f/i/r;->h0(Ld/l/f/i/h0;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object v1, p0, Ld/l/f/i/n;->P:Landroid/media/ImageReader;

    new-instance v2, Ld/l/f/i/r$a;

    invoke-direct {v2, p0}, Ld/l/f/i/r$a;-><init>(Ld/l/f/i/r;)V
    ...
    iget-object v2, p0, Ld/l/f/i/n;->P:Landroid/media/ImageReader;
    ...
    iget-boolean v1, p0, Ld/l/f/i/r;->W:Z
    ...
    iput-object v1, p0, Ld/l/f/i/n;->Q:Landroid/media/ImageReader;

    new-instance v2, Ld/l/f/i/r$b;

    invoke-direct {v2, p0}, Ld/l/f/i/r$b;-><init>(Ld/l/f/i/r;)V
    ...
    iget-object v2, p0, Ld/l/f/i/n;->Q:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Ld/l/f/i/n;->R:Landroid/media/ImageReader;

    new-instance v1, Ld/l/f/i/r$c;

    invoke-direct {v1, p0}, Ld/l/f/i/r$c;-><init>(Ld/l/f/i/r;)V
    ...
    iget-object p0, p0, Ld/l/f/i/n;->R:Landroid/media/ImageReader;
...
.method public p()Z
    ...
    iget-boolean v0, p0, Ld/l/f/i/r;->W:Z
    ...
    iget-object v1, p0, Ld/l/f/i/v;->o:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, p0}, Ld/l/f/i/v$a;->f(Ld/l/f/i/v;)Z
