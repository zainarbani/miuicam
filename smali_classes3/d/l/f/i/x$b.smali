...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ld/l/f/i/x;->i(Ld/l/f/i/p$a;IZ)V
.end annotation
...
# instance fields
.field public final synthetic a:Ld/l/f/i/p$a;

.field public final synthetic b:I

.field public final synthetic c:Ld/l/f/i/x;


# direct methods
.method public constructor <init>(Ld/l/f/i/x;Ld/l/f/i/p$a;I)V
    .locals 0
    ...
    iput-object p1, p0, Ld/l/f/i/x$b;->c:Ld/l/f/i/x;

    iput-object p2, p0, Ld/l/f/i/x$b;->a:Ld/l/f/i/p$a;

    iput p3, p0, Ld/l/f/i/x$b;->b:I
...
.method public onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Ld/l/f/i/x$b;->c:Ld/l/f/i/x;

    invoke-static {v0}, Ld/l/f/i/x;->b(Ld/l/f/i/x;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Ld/l/f/i/x$b;->c:Ld/l/f/i/x;

    const/4 p2, 0x0

    invoke-static {p1, p2}, Ld/l/f/i/x;->c(Ld/l/f/i/x;Z)Z

    iget-object p1, p0, Ld/l/f/i/x$b;->c:Ld/l/f/i/x;

    invoke-static {p1}, Ld/l/f/i/x;->b(Ld/l/f/i/x;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Ld/l/f/i/x$b;->c:Ld/l/f/i/x;

    invoke-static {p0}, Ld/l/f/i/x;->d(Ld/l/f/i/x;)J
...
.method public onYuvAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    iget-object p2, p0, Ld/l/f/i/x$b;->c:Ld/l/f/i/x;

    const/4 v1, 0x0

    invoke-static {p2, v1}, Ld/l/f/i/x;->c(Ld/l/f/i/x;Z)Z

    iget-object p2, p0, Ld/l/f/i/x$b;->a:Ld/l/f/i/p$a;

    iget v1, p0, Ld/l/f/i/x$b;->b:I

    invoke-virtual {p2, p1, v1, p3}, Ld/l/f/i/p$a;->F(Landroid/media/Image;IZ)V
