.class public abstract Ld/l/f/i/v;
...
.field public w:Ld/l/f/i/v$a;

.field private x:Landroid/os/ConditionVariable;

.field public y:Ld/l/f/i/s;
...
.method public constructor <init>(Ld/l/f/i/v$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object v0, p0, Ld/l/f/i/v;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Ld/l/f/i/v;->p:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Ld/l/f/i/v;->q:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v0, 0x4

    iput v0, p0, Ld/l/f/i/v;->r:I

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Ld/l/f/i/v;->t:Ljava/lang/Object;

    new-instance v2, Landroid/os/ConditionVariable;

    invoke-direct {v2}, Landroid/os/ConditionVariable;-><init>()V

    iput-object v2, p0, Ld/l/f/i/v;->x:Landroid/os/ConditionVariable;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Ld/l/f/i/v;->B:Ljava/lang/Object;

    new-instance v2, Ljava/util/LinkedList;

    invoke-direct {v2}, Ljava/util/LinkedList;-><init>()V

    iput-object v2, p0, Ld/l/f/i/v;->C:Ljava/util/LinkedList;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Ld/l/f/i/v;->D:Ljava/lang/Object;

    iput v1, p0, Ld/l/f/i/v;->E:I
    ...
    iput-object p1, p0, Ld/l/f/i/v;->w:Ld/l/f/i/v$a;
    ...
    :goto_0
    iput-boolean p1, p0, Ld/l/f/i/v;->A:Z

    sget-object p1, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    new-array v0, v0, [Ljava/lang/Object;

    invoke-virtual {p0}, Ld/l/f/i/v;->i()Ljava/lang/String;
    ...
    iput-object p1, p0, Ld/l/f/i/v;->z:Ljava/lang/String;
    ...
    iput-object v0, p0, Ld/l/f/i/v;->u:Landroid/os/HandlerThread;

    new-instance p1, Ld/l/f/i/s;

    invoke-direct {p1}, Ld/l/f/i/s;-><init>()V

    iput-object p1, p0, Ld/l/f/i/v;->y:Ld/l/f/i/s;
    ...
    invoke-virtual {p1, p0}, Ld/l/f/i/s;->d(Landroid/util/Size;)V
...
.method public C(Z)V
    ...
    iput-boolean p1, p0, Ld/l/f/i/v;->s:Z
...
.method public D(I)V
    ...
    iget-object v0, p0, Ld/l/f/i/v;->D:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iput p1, p0, Ld/l/f/i/v;->E:I
...
.method public G()V
    ...
    iget-object v0, p0, Ld/l/f/i/v;->u:Landroid/os/HandlerThread;
    ...
    :try_start_0
    new-instance v1, Ld/l/f/i/v$b;

    iget-object v3, p0, Ld/l/f/i/v;->u:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    invoke-direct {v1, v3, p0}, Ld/l/f/i/v$b;-><init>(Landroid/os/Looper;Ld/l/f/i/v;)V

    iput-object v1, p0, Ld/l/f/i/v;->v:Landroid/os/Handler;
    ...
    invoke-virtual {p0, v0}, Ld/l/f/i/v;->D(I)V
...
.method public H()V
    ...
    iput-object v3, p0, Ld/l/f/i/v;->v:Landroid/os/Handler;
...
.method public J()Z
    ...
    invoke-virtual {p0, v2}, Ld/l/f/i/v;->D(I)V
...
.method public K()V
    ...
    invoke-virtual {p0}, Ld/l/f/i/v;->s()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Ld/l/f/i/v;->p()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Ld/l/f/i/v;->H()V
...
.method public abstract e(Ld/l/f/i/h0;)I
...
.method public f(Ld/l/f/i/t;)V
    ...
    iget-object v0, p1, Ld/l/f/i/t;->a:Landroid/media/Image;

    invoke-virtual {v0}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v1

    iget v3, p1, Ld/l/f/i/t;->b:I

    iget-object v4, p0, Ld/l/f/i/v;->w:Ld/l/f/i/v$a;
    ...
    invoke-interface {v4, v1, v2}, Ld/l/f/i/v$a;->g(J)Ld/l/f/i/a0;
    ...
    :cond_0
    sget-boolean v8, Ld/l/f/i/e0;->q:Z

    if-nez v8, :cond_1

    invoke-virtual {v4}, Ld/l/f/i/a0;->e()I

    move-result v8

    invoke-static {v8}, Ld/l/f/e/c;->d(I)Z
    ...
    iget-object v1, p0, Ld/l/f/i/v;->y:Ld/l/f/i/s;

    invoke-virtual {v1, v4, v0, v3}, Ld/l/f/i/s;->a(Ld/l/f/i/a0;Landroid/media/Image;I)V
    ...
    invoke-static {v1}, Ld/l/f/e/c;->d(I)Z
    ...
    iget-boolean p1, p1, Ld/l/f/i/t;->c:Z

    invoke-interface {v2, v0, v3, p1}, Ld/l/f/i/v$a;->c(Landroid/media/Image;IZ)V
    ...
    :goto_2
    sget-boolean p1, Ld/l/f/i/e0;->p:Z
    ...
    :cond_6
    iget-object p1, p0, Ld/l/f/i/v;->q:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_7
    iget-object p1, p0, Ld/l/f/i/v;->p:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_8
    iget-object p1, p0, Ld/l/f/i/v;->o:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public o()Z
    ...
    iget-boolean p0, p0, Ld/l/f/i/v;->A:Z
...
.method public y(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;
    ...
    invoke-static {p1, p2, p0}, Ld/l/f/e/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
...
.method public z()V
    ...
    iput-object v0, p0, Ld/l/f/i/v;->y:Ld/l/f/i/s;
