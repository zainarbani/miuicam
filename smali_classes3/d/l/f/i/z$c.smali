...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ld/l/f/i/z;->x(Landroid/media/Image;IIZ)V
.end annotation
...
.field public final synthetic e:Ld/l/f/i/z;


# direct methods
.method public constructor <init>(Ld/l/f/i/z;Landroid/media/Image;IIZ)V
    .locals 0
    ...
    iput-object p1, p0, Ld/l/f/i/z$c;->e:Ld/l/f/i/z;

    iput-object p2, p0, Ld/l/f/i/z$c;->a:Landroid/media/Image;

    iput p3, p0, Ld/l/f/i/z$c;->b:I

    iput p4, p0, Ld/l/f/i/z$c;->c:I

    iput-boolean p5, p0, Ld/l/f/i/z$c;->d:Z
...
.method public run()V
    ...
    :try_start_0
    iget-object v4, v0, Ld/l/f/i/z$c;->a:Landroid/media/Image;
    ...
    iget-object v6, v0, Ld/l/f/i/z$c;->e:Ld/l/f/i/z;
    ...
    iget-object v8, v0, Ld/l/f/i/z$c;->e:Ld/l/f/i/z;

    invoke-static {v8}, Ld/l/f/i/z;->e(Ld/l/f/i/z;)Ljava/util/Map;
    ...
    check-cast v8, Ld/l/f/i/p;

    if-nez v8, :cond_2

    if-eqz v6, :cond_1

    invoke-virtual {v6}, Ld/l/f/i/p$a;->c()Ljava/lang/String;
    ...
    iget-object v9, v0, Ld/l/f/i/z$c;->e:Ld/l/f/i/z;

    invoke-static {v9}, Ld/l/f/i/z;->e(Ld/l/f/i/z;)Ljava/util/Map;
    ...
    new-instance v10, Ld/l/f/i/f;

    invoke-direct {v10, v8}, Ld/l/f/i/f;-><init>(Ljava/lang/String;)V

    invoke-interface {v9, v10}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v9

    sget-object v10, Ld/l/f/i/e;->a:Ld/l/f/i/e;
    ...
    invoke-static {v8, v4, v5}, Ld/l/f/i/z;->f(Ld/l/f/i/z;J)J
    ...
    iget-object v10, v0, Ld/l/f/i/z$c;->e:Ld/l/f/i/z;

    invoke-static {v10}, Ld/l/f/i/z;->e(Ld/l/f/i/z;)Ljava/util/Map;
    ...
    :cond_3
    invoke-virtual {v8}, Ld/l/f/i/p;->q()I

    move-result v7

    invoke-virtual {v8}, Ld/l/f/i/p;->z()Z

    move-result v9

    invoke-virtual {v8}, Ld/l/f/i/p;->p()Le/c;

    move-result-object v10

    invoke-virtual {v8}, Ld/l/f/i/p;->v()Z

    move-result v11

    invoke-virtual {v8}, Ld/l/f/i/p;->i()J
    ...
    invoke-direct/range {v14 .. v19}, Ld/l/f/i/p$a;-><init>(IZLe/c;ZZ)V

    iget-object v2, v0, Ld/l/f/i/z$c;->e:Ld/l/f/i/z;

    invoke-static {v2}, Ld/l/f/i/z;->g(Ld/l/f/i/z;)Landroid/util/LongSparseArray;
    ...
    invoke-virtual {v6, v9, v10}, Ld/l/f/i/p$a;->C(J)V

    invoke-virtual {v6, v8}, Ld/l/f/i/p$a;->D(Z)V
    ...
    iget-object v1, v0, Ld/l/f/i/z$c;->a:Landroid/media/Image;

    iget v2, v0, Ld/l/f/i/z$c;->b:I

    iget v3, v0, Ld/l/f/i/z$c;->c:I

    iget-boolean v4, v0, Ld/l/f/i/z$c;->d:Z

    invoke-virtual {v6, v1, v2, v3, v4}, Ld/l/f/i/p$a;->E(Landroid/media/Image;IIZ)V

    iget-object v0, v0, Ld/l/f/i/z$c;->e:Ld/l/f/i/z;
    ...
    iget-object v0, v0, Ld/l/f/i/z$c;->a:Landroid/media/Image;
