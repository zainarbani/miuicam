...
.method private f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    :cond_0
    new-instance p1, Ld/l/f/i/g0$d;

    invoke-direct {p1, p0}, Ld/l/f/i/g0$d;-><init>(Ld/l/f/i/g0;)V
    ...
    :cond_2
    new-instance p1, Ld/l/f/i/g0$e;

    invoke-direct {p1, p0}, Ld/l/f/i/g0$e;-><init>(Ld/l/f/i/g0;)V
...
.method public X(Ld/l/f/i/h0;)V
    ...
    invoke-virtual {v3}, Ld/l/f/i/p$a;->u()Z
    ...
    invoke-virtual {p0, v5}, Ld/l/f/i/v;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v6, v1}, Ld/l/f/e/e;->b(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v6, v5, v1, v7}, Ld/l/f/i/g0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    sget-object v9, Ld/c/b/v5/vo;->H:Ld/c/b/v5/xo;

    invoke-static {v8, v9}, Ld/c/b/v5/yo;->l(Landroid/hardware/camera2/CaptureRequest;Ld/c/b/v5/xo;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Ld/l/f/i/h0;->b()I
    ...
    invoke-direct {p0, v6, v5, v7, v8}, Ld/l/f/i/g0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-object v5, p0, Ld/l/f/i/v;->w:Ld/l/f/i/v$a;

    invoke-virtual {p0, v4, v5}, Ld/l/f/i/n;->b0(Landroid/media/Image;Ld/l/f/i/v$a;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    new-instance v2, Ld/l/f/i/g0$a;

    invoke-direct {v2, p0}, Ld/l/f/i/g0$a;-><init>(Ld/l/f/i/g0;)V
    ...
    new-instance v2, Ld/l/f/i/g0$b;

    invoke-direct {v2, p0}, Ld/l/f/i/g0$b;-><init>(Ld/l/f/i/g0;)V
    ...
    new-instance v1, Ld/l/f/i/g0$c;

    invoke-direct {v1, p0}, Ld/l/f/i/g0$c;-><init>(Ld/l/f/i/g0;)V
