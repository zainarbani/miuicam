...
.method public constructor <init>(Ljava/lang/String;Landroid/graphics/Paint;)V
    ...
    iput-object p1, p0, Ld/l/e0/f;->s:Ljava/lang/String;

    iput-object p2, p0, Ld/l/e0/f;->t:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Ld/l/e0/f;->u:Landroid/graphics/Rect;
...
.method public final B()Landroid/graphics/Paint;
    ...
    iget-object p0, p0, Ld/l/e0/f;->t:Landroid/graphics/Paint;
...
.method public final C()Ljava/lang/String;
    ...
    iget-object p0, p0, Ld/l/e0/f;->s:Ljava/lang/String;
...
.method public a(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Ld/l/e0/f;->s:Ljava/lang/String;

    iget-object v1, p0, Ld/l/e0/f;->u:Landroid/graphics/Rect;
...
.method public l()Landroid/util/Size;
    ...
    iget-object v0, p0, Ld/l/e0/f;->t:Landroid/graphics/Paint;

    iget-object v1, p0, Ld/l/e0/f;->s:Ljava/lang/String;

    invoke-virtual {v1}, Ljava/lang/String;->length()I

    move-result v2

    iget-object v3, p0, Ld/l/e0/f;->u:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v0, v1}, Ld/l/e0/f;->D(Landroid/graphics/Paint;Ljava/lang/String;)I

    move-result v0

    new-instance v1, Landroid/util/Size;

    iget-object p0, p0, Ld/l/e0/f;->u:Landroid/graphics/Rect;
