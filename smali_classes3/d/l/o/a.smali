...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ld/l/o/a;->a:Landroid/media/MediaFormat;

    iput-object v0, p0, Ld/l/o/a;->b:Landroid/media/MediaFormat;

    iput-object v0, p0, Ld/l/o/a;->c:Landroid/media/MediaCodec;

    iput-object v0, p0, Ld/l/o/a;->d:Landroid/media/MediaCodec$BufferInfo;

    const/4 v1, 0x0

    iput v1, p0, Ld/l/o/a;->e:I

    iput-object v0, p0, Ld/l/o/a;->f:[B

    const/4 v0, 0x4

    iput v0, p0, Ld/l/o/a;->g:I

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Ld/l/o/a;->h:D

    iput v1, p0, Ld/l/o/a;->i:I

    iput-boolean v1, p0, Ld/l/o/a;->k:Z

    iput-boolean v1, p0, Ld/l/o/a;->l:Z

    iput-wide v2, p0, Ld/l/o/a;->o:D

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Ld/l/o/a;->p:J
...
.method public a(Lcom/xiaomi/magicvideoskymediacodec/MiHWEncoder;)V
    ...
    iput-object p1, p0, Ld/l/o/a;->j:Lcom/xiaomi/magicvideoskymediacodec/MiHWEncoder;
...
.method public c(I[BD)Z
    ...
    iget-object v1, p0, Ld/l/o/a;->c:Landroid/media/MediaCodec;
    ...
    iget-object v4, p0, Ld/l/o/a;->c:Landroid/media/MediaCodec;
    ...
    :cond_0
    iget-object p1, p0, Ld/l/o/a;->c:Landroid/media/MediaCodec;

    iget-object p2, p0, Ld/l/o/a;->d:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object p2, p0, Ld/l/o/a;->j:Lcom/xiaomi/magicvideoskymediacodec/MiHWEncoder;

    if-eqz p2, :cond_1

    iget-object p2, p0, Ld/l/o/a;->c:Landroid/media/MediaCodec;

    invoke-virtual {p2}, Landroid/media/MediaCodec;->getOutputFormat()Landroid/media/MediaFormat;

    move-result-object p2

    iput-object p2, p0, Ld/l/o/a;->b:Landroid/media/MediaFormat;

    iget-object p3, p0, Ld/l/o/a;->j:Lcom/xiaomi/magicvideoskymediacodec/MiHWEncoder;
    ...
    iget-object p3, p0, Ld/l/o/a;->d:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object p4, p0, Ld/l/o/a;->d:Landroid/media/MediaCodec$BufferInfo;
    ...
    new-instance p2, Ld/l/o/h;

    invoke-direct {p2}, Ld/l/o/h;-><init>()V

    new-instance p4, Ld/l/o/h$c;

    invoke-direct {p4, p2}, Ld/l/o/h$c;-><init>(Ld/l/o/h;)V

    iput-object p3, p4, Ld/l/o/h$c;->a:Ljava/nio/ByteBuffer;

    new-instance v4, Landroid/media/MediaCodec$BufferInfo;

    invoke-direct {v4}, Landroid/media/MediaCodec$BufferInfo;-><init>()V

    iput-object v4, p4, Ld/l/o/h$c;->b:Landroid/media/MediaCodec$BufferInfo;
...
.method public e(I)V
    ...
    :try_start_0
    iget-boolean v1, p0, Ld/l/o/a;->k:Z
    ...
    :cond_0
    invoke-direct {p0, p1}, Ld/l/o/a;->d(I)I

    move-result v1

    iput v1, p0, Ld/l/o/a;->g:I
    ...
    iput-object p1, p0, Ld/l/o/a;->a:Landroid/media/MediaFormat;
    ...
    iget-object p1, p0, Ld/l/o/a;->a:Landroid/media/MediaFormat;
    ...
    iput-object p1, p0, Ld/l/o/a;->c:Landroid/media/MediaCodec;

    new-instance p1, Landroid/media/MediaCodec$BufferInfo;

    invoke-direct {p1}, Landroid/media/MediaCodec$BufferInfo;-><init>()V

    iput-object p1, p0, Ld/l/o/a;->d:Landroid/media/MediaCodec$BufferInfo;
    ...
    iput-wide v0, p0, Ld/l/o/a;->h:D

    iget-object v0, p0, Ld/l/o/a;->a:Landroid/media/MediaFormat;
...
.method public f()V
    ...
    iget-object v0, p0, Ld/l/o/a;->c:Landroid/media/MediaCodec;
    ...
    iput-boolean v0, p0, Ld/l/o/a;->k:Z
