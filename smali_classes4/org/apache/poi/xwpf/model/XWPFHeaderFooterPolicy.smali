...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    invoke-static {}, Ln/d$a;->a()Ln/d;

    move-result-object v2

    invoke-interface {v2}, Ln/d;->by()Ln/j;

    move-result-object v3

    const-string v4, "_x0000_t136"

    invoke-interface {v3, v4}, Ln/j;->setId(Ljava/lang/String;)V

    const-string v4, "1600,21600"

    invoke-interface {v3, v4}, Ln/j;->R5(Ljava/lang/String;)V

    const/high16 v4, 0x43080000    # 136.0f

    invoke-interface {v3, v4}, Ln/j;->f7(F)V

    const-string v4, "10800"

    invoke-interface {v3, v4}, Ln/j;->C7(Ljava/lang/String;)V

    const-string v4, "m@7,0l@8,0m@5,21600l@6,21600e"

    invoke-interface {v3, v4}, Ln/j;->Z7(Ljava/lang/String;)V

    invoke-interface {v3}, Ln/j;->h3()Ln/c;

    move-result-object v4

    invoke-interface {v4}, Ln/c;->addNewF()Ln/a;

    move-result-object v5

    const-string v6, "sum #0 0 10800"

    invoke-interface {v5, v6}, Ln/a;->Wa(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v5}, Ln/a;->Wa(Ljava/lang/String;)V

    invoke-interface {v3}, Ln/j;->addNewPath()Ln/g;

    move-result-object v4

    sget-object v5, Ln/a0;->u8:Ln/a0$a;

    invoke-interface {v4, v5}, Ln/g;->gn(Ln/a0$a;)V

    sget-object v6, Lm/e;->H7:Lm/e$a;

    invoke-interface {v4, v6}, Ln/g;->gv(Lm/e$a;)V

    const-string v6, "@9,0;@10,10800;@11,21600;@12,10800"

    invoke-interface {v4, v6}, Ln/g;->Hw(Ljava/lang/String;)V

    const-string v6, "270,180,90,0"

    invoke-interface {v4, v6}, Ln/g;->ds(Ljava/lang/String;)V

    invoke-interface {v3}, Ln/j;->G4()Ln/l;

    move-result-object v4

    invoke-interface {v4, v5}, Ln/l;->u(Ln/a0$a;)V

    invoke-interface {v4, v5}, Ln/l;->at(Ln/a0$a;)V

    invoke-interface {v3}, Ln/j;->K2()Ln/f;

    move-result-object v4

    invoke-interface {v4}, Ln/f;->addNewH()Ln/e;

    move-result-object v4

    const-string v5, "#0,bottomRight"

    invoke-interface {v4, v5}, Ln/e;->setPosition(Ljava/lang/String;)V

    const-string v5, "6629,14971"

    invoke-interface {v4, v5}, Ln/e;->Gn(Ljava/lang/String;)V

    invoke-interface {v3}, Ln/j;->addNewLock()Lm/b;

    move-result-object v3

    sget-object v4, Ln/p;->h8:Ln/p$a;

    invoke-interface {v3, v4}, Lm/b;->Z5(Ln/p$a;)V

    invoke-interface {v2}, Ln/d;->Sv()Ln/i;
    ...
    invoke-interface {v3, v4}, Ln/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Ln/i;->B0(Ljava/lang/String;)V

    const-string p2, "#_x0000_t136"

    invoke-interface {v3, p2}, Ln/i;->setType(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Ln/i;->d(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Ln/i;->U2(Ljava/lang/String;)V

    const-string p2, "black"

    invoke-interface {v3, p2}, Ln/i;->I6(Ljava/lang/String;)V

    sget-object p2, Ln/a0;->x8:Ln/a0$a;

    invoke-interface {v3, p2}, Ln/i;->t7(Ln/a0$a;)V

    invoke-interface {v3}, Ln/i;->G4()Ln/l;

    move-result-object p2

    const-string v3, "font-family:&quot;Cambria&quot;;font-size:1pt"

    invoke-interface {p2, v3}, Ln/l;->d(Ljava/lang/String;)V

    invoke-interface {p2, p1}, Ln/l;->cF(Ljava/lang/String;)V
