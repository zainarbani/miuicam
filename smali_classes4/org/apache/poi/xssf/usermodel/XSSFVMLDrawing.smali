...
.method private newDrawing()V
    ...
    invoke-static {}, Lm/c$a;->a()Lm/c;

    move-result-object v0

    sget-object v1, Ln/p;->h8:Ln/p$a;

    invoke-interface {v0, v1}, Lm/c;->Z5(Ln/p$a;)V

    invoke-interface {v0}, Lm/c;->hF()Lm/a;

    move-result-object v2

    invoke-interface {v2, v1}, Lm/a;->Z5(Ln/p$a;)V

    const-string v1, "1"

    invoke-interface {v2, v1}, Lm/a;->setData(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Ln/j;->setId(Ljava/lang/String;)V

    const-string v1, "21600,21600"

    invoke-interface {v0, v1}, Ln/j;->R5(Ljava/lang/String;)V

    const/high16 v1, 0x434a0000    # 202.0f

    invoke-interface {v0, v1}, Ln/j;->f7(F)V

    const-string v1, "m,l,21600r21600,l21600,xe"

    invoke-interface {v0, v1}, Ln/j;->Z7(Ljava/lang/String;)V

    invoke-interface {v0}, Ln/j;->e6()Ln/k;

    move-result-object v1

    sget-object v2, Ln/y;->p8:Ln/y$a;

    invoke-interface {v1, v2}, Ln/k;->uD(Ln/y$a;)V

    invoke-interface {v0}, Ln/j;->addNewPath()Ln/g;

    move-result-object v1

    sget-object v2, Ln/a0;->u8:Ln/a0$a;

    invoke-interface {v1, v2}, Ln/g;->wc(Ln/a0$a;)V

    sget-object v2, Lm/e;->F7:Lm/e$a;

    invoke-interface {v1, v2}, Ln/g;->gv(Lm/e$a;)V
...
.method public findCommentShape(II)Ln/i;
    .locals 5
    ...
    invoke-interface {v0, v1}, Ln/i;->j6(I)Ll/a;

    move-result-object v2

    invoke-interface {v2}, Ll/a;->SB()Ll/c$a;

    move-result-object v3

    sget-object v4, Ll/c;->N6:Ll/c$a;

    if-ne v3, v4, :cond_0

    invoke-interface {v2, v1}, Ll/a;->getRowArray(I)Ljava/math/BigInteger;
    ...
    invoke-interface {v2, v1}, Ll/a;->UD(I)Ljava/math/BigInteger;
...
.method public newCommentShape()Ln/i;
    .locals 5

    invoke-static {}, Ln/i$a;->a()Ln/i;
    ...
    invoke-interface {v0, v1}, Ln/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Ln/i;->setType(Ljava/lang/String;)V

    const-string v1, "position:absolute; visibility:hidden"

    invoke-interface {v0, v1}, Ln/i;->d(Ljava/lang/String;)V

    const-string v1, "#ffffe1"

    invoke-interface {v0, v1}, Ln/i;->I6(Ljava/lang/String;)V

    sget-object v2, Lm/h;->N7:Lm/h$a;

    invoke-interface {v0, v2}, Ln/i;->A(Lm/h$a;)V

    invoke-interface {v0}, Ln/i;->addNewFill()Ln/b;

    move-result-object v2

    invoke-interface {v2, v1}, Ln/b;->setColor(Ljava/lang/String;)V

    invoke-interface {v0}, Ln/i;->addNewShadow()Ln/h;

    move-result-object v1

    sget-object v2, Ln/a0;->u8:Ln/a0$a;

    invoke-interface {v1, v2}, Ln/h;->u(Ln/a0$a;)V

    const-string v3, "black"

    invoke-interface {v1, v3}, Ln/h;->setColor(Ljava/lang/String;)V

    invoke-interface {v1, v2}, Ln/h;->SA(Ln/a0$a;)V

    invoke-interface {v0}, Ln/i;->addNewPath()Ln/g;

    move-result-object v1

    sget-object v2, Lm/e;->E7:Lm/e$a;

    invoke-interface {v1, v2}, Ln/g;->gv(Lm/e$a;)V

    invoke-interface {v0}, Ln/i;->q0()Ln/m;

    move-result-object v1

    const-string v2, "mso-direction-alt:auto"

    invoke-interface {v1, v2}, Ln/m;->d(Ljava/lang/String;)V

    invoke-interface {v0}, Ln/i;->addNewClientData()Ll/a;

    move-result-object v1

    sget-object v2, Ll/c;->N6:Ll/c$a;

    invoke-interface {v1, v2}, Ll/a;->aA(Ll/c$a;)V

    invoke-interface {v1}, Ll/a;->pc()Ll/d;

    invoke-interface {v1}, Ll/a;->xu()Ll/d;

    invoke-interface {v1}, Ll/a;->addNewAnchor()Lorg/apache/xmlbeans/XmlString;
    ...
    invoke-interface {v1}, Ll/a;->Rq()Ll/d;
    ...
    invoke-interface {v1}, Ll/a;->addNewRow()Lorg/apache/xmlbeans/XmlInteger;
    ...
    invoke-interface {v1}, Ll/a;->c8()Lorg/apache/xmlbeans/XmlInteger;
...
.method public read(Ljava/io/InputStream;)V
    ...
    invoke-static {v2}, Lm/c$a;->k(Ljava/lang/String;)Lm/c;
    ...
    invoke-static {v2}, Ln/j$a;->k(Ljava/lang/String;)Ln/j;
    ...
    invoke-interface {v2}, Ln/j;->getId()Ljava/lang/String;
    ...
    invoke-static {v2}, Ln/i$a;->k(Ljava/lang/String;)Ln/i;

    move-result-object v2

    invoke-interface {v2}, Ln/i;->getId()Ljava/lang/String;
...
.method public removeCommentShape(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;->findCommentShape(II)Ln/i;
