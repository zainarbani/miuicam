...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Lmiuix/appcompat/internal/widget/DialogParentPanel2$a;->g(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Lh/f/d/g;->j(Landroid/content/Context;)Z
...
.method private b(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I
    .locals 2
    ...
    :cond_0
    invoke-direct {p0}, Lmiuix/appcompat/internal/widget/DialogParentPanel2$a;->i()Z
    ...
    :goto_0
    invoke-direct {p0, p3, p2}, Lmiuix/appcompat/internal/widget/DialogParentPanel2$a;->h(Landroid/util/TypedValue;Z)I
    ...
    :goto_1
    invoke-direct {p0, p5, p2}, Lmiuix/appcompat/internal/widget/DialogParentPanel2$a;->h(Landroid/util/TypedValue;Z)I
...
.method private e()Z
    ...
    invoke-direct {p0, v0}, Lmiuix/appcompat/internal/widget/DialogParentPanel2$a;->d(Landroid/content/Context;)Z
...
.method private g(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget p2, Lh/c/b$r;->Window_windowFixedWidthMinor:I
    ...
    :cond_1
    sget p2, Lh/c/b$r;->Window_windowFixedHeightMajor:I
    ...
    :cond_2
    sget p2, Lh/c/b$r;->Window_windowFixedWidthMajor:I
    ...
    :cond_3
    sget p2, Lh/c/b$r;->Window_windowFixedHeightMinor:I
    ...
    :cond_4
    sget p2, Lh/c/b$r;->Window_windowMaxWidthMinor:I
    ...
    :cond_5
    sget p2, Lh/c/b$r;->Window_windowMaxWidthMajor:I
    ...
    :cond_6
    sget p2, Lh/c/b$r;->Window_windowMaxHeightMajor:I
    ...
    :cond_7
    sget p2, Lh/c/b$r;->Window_windowMaxHeightMinor:I
...
.method private h(Landroid/util/TypedValue;Z)I
    .locals 2
...
.method private i()Z
    ...
    invoke-direct {p0}, Lmiuix/appcompat/internal/widget/DialogParentPanel2$a;->e()Z
...
.method public a(I)I
    ...
    invoke-direct/range {v0 .. v6}, Lmiuix/appcompat/internal/widget/DialogParentPanel2$a;->b(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I
...
.method public f()V
    ...
    invoke-static {v0, v1}, Lh/f/d/m;->f(Landroid/content/Context;Landroid/graphics/Point;)V
