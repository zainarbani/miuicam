...
.field private b:Lh/c/e/e/f/g$b;

.field private c:Z

.field private d:Lh/c/e/e/f/m/c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance p1, Lh/c/e/e/f/m/c;

    invoke-direct {p1, p0}, Lh/c/e/e/f/m/c;-><init>(Landroid/widget/LinearLayout;)V

    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ActionMenuItemView;->d:Lh/c/e/e/f/m/c;
...
.method public a(Lh/c/e/e/f/i;I)V
    ...
    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ActionMenuItemView;->a:Lh/c/e/e/f/i;

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, Landroid/widget/LinearLayout;->setSelected(Z)V

    invoke-virtual {p1}, Lh/c/e/e/f/i;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1}, Lh/c/e/e/f/i;->isChecked()Z
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ActionMenuItemView;->d:Lh/c/e/e/f/m/c;

    invoke-virtual {p1}, Lh/c/e/e/f/i;->getContentDescription()Ljava/lang/CharSequence;

    move-result-object p1

    invoke-virtual {p0, p1}, Lh/c/e/e/f/m/c;->c(Ljava/lang/CharSequence;)V
...
.method public getItemData()Lh/c/e/e/f/i;
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ActionMenuItemView;->a:Lh/c/e/e/f/i;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ActionMenuItemView;->d:Lh/c/e/e/f/m/c;
    ...
    invoke-virtual {p1, v0}, Lh/c/e/e/f/m/c;->b(Landroid/content/res/Configuration;)V

    invoke-virtual {p0}, Landroid/widget/LinearLayout;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Lh/c/b$g;->miuix_appcompat_action_button_bg_top_padding:I
    ...
    sget v1, Lh/c/b$g;->miuix_appcompat_action_button_bg_bottom_padding:I
...
.method public performClick()Z
    ...
    :cond_0
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ActionMenuItemView;->b:Lh/c/e/e/f/g$b;

    const/4 v2, 0x0

    if-eqz v0, :cond_1

    iget-object v3, p0, Lmiuix/appcompat/internal/view/menu/action/ActionMenuItemView;->a:Lh/c/e/e/f/i;

    invoke-interface {v0, v3}, Lh/c/e/e/f/g$b;->b(Lh/c/e/e/f/i;)Z
...
.method public setEnabled(Z)V
    ...
    invoke-virtual {p0, p1}, Lh/c/e/e/f/m/c;->d(Z)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Lh/c/e/e/f/m/c;->e(Landroid/graphics/drawable/Drawable;)V
...
.method public setItemInvoker(Lh/c/e/e/f/g$b;)V
    ...
    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ActionMenuItemView;->b:Lh/c/e/e/f/g$b;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1}, Lh/c/e/e/f/m/c;->g(Ljava/lang/CharSequence;)V
