...
# static fields
.field private static final c:Ljava/lang/String; = "miuix:hour"

.field private static final d:Ljava/lang/String; = "miuix:minute"

.field private static final e:Ljava/lang/String; = "miuix:is24hour"


# instance fields
.field private final f:Lmiuix/pickerwidget/widget/TimePicker;

.field private final g:Lmiuix/appcompat/app/TimePickerDialog$b;
...
.method public constructor <init>(Landroid/content/Context;ILmiuix/appcompat/app/TimePickerDialog$b;IIZ)V
    ...
    iput-object p3, p0, Lmiuix/appcompat/app/TimePickerDialog;->g:Lmiuix/appcompat/app/TimePickerDialog$b;

    iput p4, p0, Lmiuix/appcompat/app/TimePickerDialog;->h:I

    iput p5, p0, Lmiuix/appcompat/app/TimePickerDialog;->i:I

    iput-boolean p6, p0, Lmiuix/appcompat/app/TimePickerDialog;->j:Z

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lmiuix/appcompat/app/AlertDialog;->setIcon(I)V

    sget p1, Lh/c/b$p;->time_picker_dialog_title:I
    ...
    sget p2, Lh/c/b$m;->miuix_appcompat_time_picker_dialog:I
    ...
    iput-object p1, p0, Lmiuix/appcompat/app/TimePickerDialog;->f:Lmiuix/pickerwidget/widget/TimePicker;

    iget-boolean p2, p0, Lmiuix/appcompat/app/TimePickerDialog;->j:Z
    ...
    iget p2, p0, Lmiuix/appcompat/app/TimePickerDialog;->h:I
    ...
    iget p0, p0, Lmiuix/appcompat/app/TimePickerDialog;->i:I
...
.method public static synthetic u(Lmiuix/appcompat/app/TimePickerDialog;)V
    .locals 0

    invoke-direct {p0}, Lmiuix/appcompat/app/TimePickerDialog;->v()V
...
.method private v()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/TimePickerDialog;->g:Lmiuix/appcompat/app/TimePickerDialog$b;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmiuix/appcompat/app/TimePickerDialog;->f:Lmiuix/pickerwidget/widget/TimePicker;

    invoke-virtual {v0}, Landroid/widget/FrameLayout;->clearFocus()V

    iget-object v0, p0, Lmiuix/appcompat/app/TimePickerDialog;->g:Lmiuix/appcompat/app/TimePickerDialog$b;

    iget-object v1, p0, Lmiuix/appcompat/app/TimePickerDialog;->f:Lmiuix/pickerwidget/widget/TimePicker;
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/TimePickerDialog;->f:Lmiuix/pickerwidget/widget/TimePicker;
...
.method public onRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/TimePickerDialog;->f:Lmiuix/pickerwidget/widget/TimePicker;
    ...
    iget-object p1, p0, Lmiuix/appcompat/app/TimePickerDialog;->f:Lmiuix/pickerwidget/widget/TimePicker;
