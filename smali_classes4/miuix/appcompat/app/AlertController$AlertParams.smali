...
.method private createListView(Lmiuix/appcompat/app/AlertController;)V
    ...
    iget v1, p1, Lmiuix/appcompat/app/AlertController;->O:I
    ...
    iget v3, p1, Lmiuix/appcompat/app/AlertController;->P:I
    ...
    iget v0, p1, Lmiuix/appcompat/app/AlertController;->Q:I

    goto :goto_0

    :cond_2
    iget v0, p1, Lmiuix/appcompat/app/AlertController;->R:I
    ...
    :cond_5
    iput-object v9, p1, Lmiuix/appcompat/app/AlertController;->L:Landroid/widget/ListAdapter;
...
.method public apply(Lmiuix/appcompat/app/AlertController;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->B0(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->F0(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->P(I)I
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->I0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v2, v0, v3, v1}, Lmiuix/appcompat/app/AlertController;->w0(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->N0(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v1, v0}, Lmiuix/appcompat/app/AlertController;->z0(ZLjava/lang/CharSequence;)V

    :cond_f
    iget-boolean v0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mHapticFeedbackEnabled:Z

    iput-boolean v0, p1, Lmiuix/appcompat/app/AlertController;->b0:Z

    iget-boolean v0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mEnableDialogImmersive:Z

    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->D0(Z)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->J0(Z)V

    iget-boolean p0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mEnableEnterAnim:Z

    invoke-virtual {p1, p0}, Lmiuix/appcompat/app/AlertController;->C0(Z)V
