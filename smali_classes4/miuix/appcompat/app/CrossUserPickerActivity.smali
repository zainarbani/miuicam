...
# static fields
.field private static final b:Ljava/lang/String; = "android.intent.extra.picked_user_id"

.field private static final c:Ljava/lang/String; = "CrossUserPickerActivity"

.field public static final d:I = -0x1


# instance fields
.field private volatile e:Landroid/content/ContextWrapper;

.field private volatile f:Landroid/content/ContentResolver;
...
.method private C6()I
    ...
    invoke-direct {p0}, Lmiuix/appcompat/app/CrossUserPickerActivity;->z6()Z
...
.method public getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/CrossUserPickerActivity;->w6()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {}, Lh/f/d/h;->i()Z

    move-result v0

    if-eqz v0, :cond_2

    iget-object v0, p0, Lmiuix/appcompat/app/CrossUserPickerActivity;->e:Landroid/content/ContextWrapper;
    ...
    :try_start_0
    iget-object v1, p0, Lmiuix/appcompat/app/CrossUserPickerActivity;->e:Landroid/content/ContextWrapper;
    ...
    invoke-direct {p0}, Lmiuix/appcompat/app/CrossUserPickerActivity;->C6()I

    move-result v3

    invoke-static {v3}, Lh/f/c/b;->a(I)Landroid/os/UserHandle;
    ...
    iput-object v1, p0, Lmiuix/appcompat/app/CrossUserPickerActivity;->e:Landroid/content/ContextWrapper;
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/CrossUserPickerActivity;->e:Landroid/content/ContextWrapper;
...
.method public getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-static {v1}, Lh/f/c/b;->a(I)Landroid/os/UserHandle;

    move-result-object v1

    invoke-static {p0, v1}, Lh/f/c/a;->a(Landroid/content/Context;Landroid/os/UserHandle;)Landroid/content/ContentResolver;
