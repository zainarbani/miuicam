...
.method public constructor <init>(Landroid/content/Context;ILmiuix/appcompat/app/AlertDialog$b;)V
    ...
    iput-object p3, p0, Lh/y/b;->a:Lmiuix/appcompat/app/AlertDialog$b;
...
.method public constructor <init>(Landroid/content/Context;Lmiuix/appcompat/app/AlertDialog$b;)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lh/y/b;-><init>(Landroid/content/Context;ILmiuix/appcompat/app/AlertDialog$b;)V
...
.method public setAdapter(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    iget-object v0, p0, Lh/y/b;->a:Lmiuix/appcompat/app/AlertDialog$b;
...
.method public setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-virtual {v0, p1, p2}, Lmiuix/appcompat/app/AlertDialog$b;->L(ILandroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$b;
...
.method public setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-virtual {v0, p1, p2}, Lmiuix/appcompat/app/AlertDialog$b;->M(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$b;
...
.method public setSingleChoiceItems(IILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lmiuix/appcompat/app/AlertDialog$b;->P(IILandroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$b;
...
.method public setSingleChoiceItems(Landroid/database/Cursor;ILjava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lmiuix/appcompat/app/AlertDialog$b;->Q(Landroid/database/Cursor;ILjava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$b;
...
.method public setSingleChoiceItems(Landroid/widget/ListAdapter;ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lmiuix/appcompat/app/AlertDialog$b;->R(Landroid/widget/ListAdapter;ILandroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$b;
...
.method public setSingleChoiceItems([Ljava/lang/CharSequence;ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lmiuix/appcompat/app/AlertDialog$b;->S([Ljava/lang/CharSequence;ILandroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$b;
...
.method public setTitle(Ljava/lang/CharSequence;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-virtual {v0, p1}, Lmiuix/appcompat/app/AlertDialog$b;->U(Ljava/lang/CharSequence;)Lmiuix/appcompat/app/AlertDialog$b;
...
.method public setView(Landroid/view/View;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-virtual {v0, p1}, Lmiuix/appcompat/app/AlertDialog$b;->X(Landroid/view/View;)Lmiuix/appcompat/app/AlertDialog$b;
