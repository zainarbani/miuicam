...
.field private static final d:Lh/f/d/i$f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh/f/d/i$f<",
...
.field private static final e:Lh/f/d/i$f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh/f/d/i$f<",
...
.field private static final f:Lh/f/d/i$f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh/f/d/i$f<",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lh/f/d/f;->b:Ljava/lang/ThreadLocal;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lh/f/d/f;->c:Ljava/lang/ThreadLocal;

    new-instance v0, Lh/f/d/f$a;

    invoke-direct {v0}, Lh/f/d/f$a;-><init>()V
    ...
    sput-object v0, Lh/f/d/f;->d:Lh/f/d/i$f;

    new-instance v0, Lh/f/d/f$b;

    invoke-direct {v0}, Lh/f/d/f$b;-><init>()V

    invoke-static {v0, v1}, Lh/f/d/i;->d(Lh/f/d/i$e;I)Lh/f/d/i$i;

    move-result-object v0

    sput-object v0, Lh/f/d/f;->e:Lh/f/d/i$f;

    new-instance v0, Lh/f/d/f$c;

    invoke-direct {v0}, Lh/f/d/f$c;-><init>()V

    invoke-static {v0, v1}, Lh/f/d/i;->d(Lh/f/d/i$e;I)Lh/f/d/i$i;

    move-result-object v0

    sput-object v0, Lh/f/d/f;->f:Lh/f/d/i$f;
    ...
    sput-object v3, Lh/f/d/f;->g:Ljava/lang/String;

    invoke-virtual {v2}, Ljava/io/PrintWriter;->close()V

    invoke-interface {v0, v1}, Lh/f/d/i$f;->release(Ljava/lang/Object;)V
...
.method public static A(Ljava/io/Reader;)Ljava/lang/String;
    ...
    sget-object v0, Lh/f/d/f;->f:Lh/f/d/i$f;
    ...
    invoke-static {p0, v1}, Lh/f/d/f;->g(Ljava/io/Reader;Ljava/io/Writer;)J
...
.method public static K(Ljava/io/OutputStream;Ljava/util/Collection;Ljava/lang/String;)V
    ...
    sget-object p2, Lh/f/d/f;->g:Ljava/lang/String;
...
.method public static h(Ljava/io/InputStream;Ljava/io/Writer;)V
    ...
    invoke-static {v0, p1}, Lh/f/d/f;->g(Ljava/io/Reader;Ljava/io/Writer;)J
...
.method public static j(Ljava/io/Reader;Ljava/io/OutputStream;)V
    ...
    invoke-static {p0, v0}, Lh/f/d/f;->g(Ljava/io/Reader;Ljava/io/Writer;)J
...
.method private static l()[B
    ...
    sget-object v0, Lh/f/d/f;->b:Ljava/lang/ThreadLocal;
...
.method private static m()[C
    ...
    sget-object v0, Lh/f/d/f;->c:Ljava/lang/ThreadLocal;
...
.method public static n(Ljava/io/InputStream;)Ljava/util/List;
    ...
    invoke-static {v0}, Lh/f/d/f;->p(Ljava/io/Reader;)Ljava/util/List;
...
.method public static q(Ljava/io/InputStream;)[B
    ...
    sget-object v0, Lh/f/d/f;->d:Lh/f/d/i$f;
    ...
    invoke-static {p0, v1}, Lh/f/d/f;->f(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static r(Ljava/io/Reader;)[B
    ...
    invoke-static {p0, v1}, Lh/f/d/f;->j(Ljava/io/Reader;Ljava/io/OutputStream;)V
...
.method public static s(Ljava/io/Reader;Ljava/lang/String;)[B
    ...
    invoke-static {p0, v1, p1}, Lh/f/d/f;->k(Ljava/io/Reader;Ljava/io/OutputStream;Ljava/lang/String;)V
...
.method public static t(Ljava/io/InputStream;)[C
    ...
    sget-object v0, Lh/f/d/f;->e:Lh/f/d/i$f;
    ...
    invoke-static {p0, v1}, Lh/f/d/f;->h(Ljava/io/InputStream;Ljava/io/Writer;)V
...
.method public static u(Ljava/io/InputStream;Ljava/lang/String;)[C
    ...
    invoke-static {p0, v1, p1}, Lh/f/d/f;->i(Ljava/io/InputStream;Ljava/io/Writer;Ljava/lang/String;)V
