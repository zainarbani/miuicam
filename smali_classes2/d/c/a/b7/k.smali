...
# static fields
.field private static final c:Ljava/lang/String; = "HeifSaveRequest"
...
.field private l:Landroid/media/ImageWriter;


# direct methods
.method public constructor <init>(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Ld/l/f/i/a0;Ld/c/a/b7/k$a;Landroid/os/Handler;)V
    .locals 0
    ...
    iput-object p1, p0, Ld/c/a/b7/k;->d:Landroid/media/Image;

    iput-object p2, p0, Ld/c/a/b7/k;->e:Landroid/hardware/camera2/CaptureResult;

    iput-object p3, p0, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;

    iput-object p4, p0, Ld/c/a/b7/k;->g:Ld/c/a/b7/k$a;

    iput-object p5, p0, Ld/c/a/b7/k;->h:Landroid/os/Handler;

    invoke-virtual {p3}, Ld/l/f/i/a0;->s()Ld/l/f/i/b0;
    ...
    iput p1, p0, Ld/c/a/b7/k;->i:I

    invoke-virtual {p2}, Landroid/util/Size;->getHeight()I

    move-result p1

    iput p1, p0, Ld/c/a/b7/k;->j:I
    ...
    :goto_0
    iget p1, p0, Ld/c/a/b7/k;->i:I

    iget p2, p0, Ld/c/a/b7/k;->j:I
...
.method private c(Landroid/hardware/camera2/CaptureResult;IIIJLandroid/location/Location;)[B
    .locals 14
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    :try_start_0
    invoke-static/range {v1 .. v11}, Ld/c/a/u3;->d(IIIJLandroid/location/Location;Landroid/hardware/camera2/CaptureResult;JLd/j/d/a/e;Z)V
    :try_end_0
    ...
    invoke-virtual {v0, v2}, Ld/j/d/a/e;->v(Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v0

    instance-of v3, v0, Ld/j/d/a/g;

    if-eqz v3, :cond_2

    move-object v3, v0

    check-cast v3, Ld/j/d/a/g;

    invoke-virtual {v3}, Ld/j/d/a/g;->j()V
...
.method private d(Landroid/media/Image;Landroid/util/Size;)[B
    .locals 7
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p1, p0}, Ld/c/a/f5;->L1(Landroid/media/Image;[I)[B
    ...
    invoke-static {v4, v1, v3}, Ld/l/g0/n0/i;->e(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v1, v3}, Ld/l/g0/n0/i;->e(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
...
.method private e(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    .locals 20
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iget-object v5, v0, Ld/c/a/b7/k;->h:Landroid/os/Handler;
    ...
    invoke-direct/range {v0 .. v8}, Ld/c/a/b7/k;->f(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/os/Handler;III)Z
    ...
    iget-object v1, v0, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;
    ...
    iget-object v6, v0, Ld/c/a/b7/k;->h:Landroid/os/Handler;
    ...
    invoke-direct/range {v0 .. v9}, Ld/c/a/b7/k;->g(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/util/Size;Landroid/os/Handler;III)Z

    move-result v0

    :goto_2
    invoke-static {v12}, Lh/f/d/f;->a(Ljava/io/Closeable;)V
...
.method private f(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/os/Handler;III)Z
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    :goto_0
    iget-object p4, p0, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;

    invoke-virtual {p4}, Ld/l/f/i/a0;->s()Ld/l/f/i/b0;

    move-result-object p4

    invoke-virtual {p4}, Ld/l/f/i/b0;->g0()I
    ...
    iput-object p4, p0, Ld/c/a/b7/k;->l:Landroid/media/ImageWriter;
    ...
    iget-object p4, p0, Ld/c/a/b7/k;->l:Landroid/media/ImageWriter;
    ...
    invoke-virtual {p3, v4, p2, v4, p1}, Ld/c/d/d;->f(I[BII)V
    ...
    :goto_2
    iget-object p2, p0, Ld/c/a/b7/k;->l:Landroid/media/ImageWriter;
    ...
    iput-object p2, p0, Ld/c/a/b7/k;->l:Landroid/media/ImageWriter;
...
.method private g(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/util/Size;Landroid/os/Handler;III)Z
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {p0, p1, p5}, Ld/c/a/b7/k;->d(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    invoke-virtual {p3, p1, p0}, Ld/c/d/d;->g(I[B)V
    ...
    invoke-virtual {p3, v4, p2, v4, p4}, Ld/c/d/d;->f(I[BII)V
...
.method public b()V
    ...
    iget-object v0, v14, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;

    invoke-virtual {v0}, Ld/l/f/i/a0;->K()Ljava/lang/String;

    move-result-object v15

    invoke-static {v15}, Ld/c/a/f5;->Y0(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v13

    iget-object v0, v14, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;

    invoke-virtual {v0}, Ld/l/f/i/a0;->t()J
    ...
    iget-object v2, v14, Ld/c/a/b7/k;->e:Landroid/hardware/camera2/CaptureResult;

    iget v3, v14, Ld/c/a/b7/k;->i:I

    iget v4, v14, Ld/c/a/b7/k;->j:I
    ...
    invoke-direct/range {v1 .. v8}, Ld/c/a/b7/k;->c(Landroid/hardware/camera2/CaptureResult;IIIJLandroid/location/Location;)[B
    ...
    invoke-virtual {v0, v15}, Ld/c/a/s5/e/c;->y(Ljava/lang/String;)Ld/c/a/s5/c/b;
    ...
    invoke-virtual {v6}, Ld/c/a/s5/c/b;->s()Z
    ...
    invoke-static {v13, v5}, Ld/c/a/b7/v;->k(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v6}, Ld/c/a/s5/c/b;->g()Ljava/lang/Long;
    ...
    iget-object v4, v14, Ld/c/a/b7/h;->a:Landroid/content/Context;

    invoke-static {v4, v11, v15}, Ld/c/a/b7/v;->z(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v2, v14, Ld/c/a/b7/k;->d:Landroid/media/Image;

    iget v1, v14, Ld/c/a/b7/k;->i:I

    iget v11, v14, Ld/c/a/b7/k;->j:I
    ...
    invoke-direct/range {v1 .. v13}, Ld/c/a/b7/k;->e(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    :try_start_0
    invoke-static {v0, v15}, Ld/c/a/v3;->j(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    ...
    :goto_1
    iget-object v1, v13, Ld/c/a/b7/h;->a:Landroid/content/Context;

    iget v7, v13, Ld/c/a/b7/k;->i:I

    iget v8, v13, Ld/c/a/b7/k;->j:I
    ...
    invoke-static/range {v1 .. v8}, Ld/c/a/b7/v;->l0(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/location/Location;III)Landroid/net/Uri;
    ...
    :goto_2
    iget-object v0, v13, Ld/c/a/b7/h;->a:Landroid/content/Context;

    move-object/from16 v6, v23

    invoke-static {v0, v6}, Ld/l/f/o/a/a;->k(Landroid/content/Context;Ld/c/a/s5/c/b;)V
    ...
    iget-object v2, v13, Ld/c/a/b7/k;->d:Landroid/media/Image;

    iget v0, v13, Ld/c/a/b7/k;->i:I

    iget v1, v13, Ld/c/a/b7/k;->j:I
    ...
    iget-object v1, v14, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;

    invoke-virtual {v1}, Ld/l/f/i/a0;->d0()Z

    move-result v1

    if-eqz v1, :cond_4

    iget-object v1, v14, Ld/c/a/b7/h;->a:Landroid/content/Context;

    invoke-static {v1, v0, v15}, Ld/c/a/c5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Ld/c/a/c5;

    move-result-object v1

    if-eqz v1, :cond_3

    iget-object v2, v14, Ld/c/a/b7/h;->b:Ld/c/a/b7/t;

    const/4 v3, 0x1

    invoke-interface {v2, v1, v3}, Ld/c/a/b7/t;->b(Ld/c/a/c5;Z)V

    goto :goto_4

    :cond_3
    iget-object v1, v14, Ld/c/a/b7/h;->b:Ld/c/a/b7/t;
    ...
    invoke-interface {v1, v0, v2, v3}, Ld/c/a/b7/t;->m(Landroid/net/Uri;Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v3}, Ld/c/a/s5/c/b;->z(Ljava/lang/Long;)V

    iget-object v3, v14, Ld/c/a/b7/h;->a:Landroid/content/Context;

    invoke-static {v3, v1}, Ld/l/f/o/a/a;->k(Landroid/content/Context;Ld/c/a/s5/c/b;)V
...
.method public onFinish()V
    ...
    iget-object v0, p0, Ld/c/a/b7/k;->g:Ld/c/a/b7/k$a;

    iget-object v1, p0, Ld/c/a/b7/k;->d:Landroid/media/Image;

    iget-object v2, p0, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;

    invoke-interface {v0, v1, v2}, Ld/c/a/b7/k$a;->a(Landroid/media/Image;Ld/l/f/i/a0;)V

    iget-object v0, p0, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;
    ...
    iget-object v5, p0, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;
    ...
    iget-object v1, p0, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;
    ...
    invoke-virtual {v2, v3}, Ld/c/a/m6/n;->j([Ljava/lang/String;)V

    invoke-static {}, Ld/j/d/a/d;->a()V

    const/4 v0, 0x0

    iput-object v0, p0, Ld/c/a/b7/k;->d:Landroid/media/Image;

    iput-object v0, p0, Ld/c/a/b7/k;->f:Ld/l/f/i/a0;

    iput-object v0, p0, Ld/c/a/b7/k;->g:Ld/c/a/b7/k$a;

    iput-object v0, p0, Ld/c/a/b7/k;->e:Landroid/hardware/camera2/CaptureResult;

    iput-object v0, p0, Ld/c/a/b7/k;->h:Landroid/os/Handler;

    iget-object v1, p0, Ld/c/a/b7/h;->b:Ld/c/a/b7/t;

    invoke-virtual {p0}, Ld/c/a/b7/k;->getSize()I

    move-result v2

    invoke-interface {v1, v2}, Ld/c/a/b7/t;->j(I)V

    iput-object v0, p0, Ld/c/a/b7/h;->b:Ld/c/a/b7/t;
...
.method public run()V
    ...
    invoke-virtual {p0}, Ld/c/a/b7/k;->b()V

    invoke-virtual {p0}, Ld/c/a/b7/k;->onFinish()V
