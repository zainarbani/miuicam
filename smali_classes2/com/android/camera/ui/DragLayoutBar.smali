...
# static fields
.field public static final a:Ljava/lang/String; = "DragLayoutBar"
...
# instance fields
.field private C8:Landroid/view/animation/Interpolator;
...
.field private v1:Landroid/animation/ValueAnimator;

.field private v2:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Ld/c/a/i7/l1;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    const/4 p2, 0x0

    iput p2, p0, Lcom/android/camera/ui/DragLayoutBar;->D8:I

    iput p2, p0, Lcom/android/camera/ui/DragLayoutBar;->E8:I

    const/4 p2, 0x1

    iput-boolean p2, p0, Lcom/android/camera/ui/DragLayoutBar;->G8:Z
...
.method public static synthetic b(Lcom/android/camera/ui/DragLayoutBar;F)F
    ...
    iput p1, p0, Lcom/android/camera/ui/DragLayoutBar;->k:F
...
.method public static synthetic d(Lcom/android/camera/ui/DragLayoutBar;)F
    ...
    iget p0, p0, Lcom/android/camera/ui/DragLayoutBar;->n:F
...
.method public static synthetic e(Lcom/android/camera/ui/DragLayoutBar;)Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/ui/DragLayoutBar;->F8:Z
...
.method public static synthetic g(Lcom/android/camera/ui/DragLayoutBar;I)I
    ...
    iput p1, p0, Lcom/android/camera/ui/DragLayoutBar;->D8:I
...
.method public static synthetic h(Lcom/android/camera/ui/DragLayoutBar;)I
    ...
    iget p0, p0, Lcom/android/camera/ui/DragLayoutBar;->E8:I
...
.method private i(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/camera/ui/DragLayoutBar;->m:F

    iget v1, p0, Lcom/android/camera/ui/DragLayoutBar;->l:F

    sub-float v0, v1, v0

    iput v0, p0, Lcom/android/camera/ui/DragLayoutBar;->n:F

    iput v1, p0, Lcom/android/camera/ui/DragLayoutBar;->k:F
    ...
    iput-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->g:Landroid/graphics/drawable/GradientDrawable;

    iget v0, p0, Lcom/android/camera/ui/DragLayoutBar;->k:F
    ...
    iget v2, p0, Lcom/android/camera/ui/DragLayoutBar;->j:F

    float-to-int v2, v2

    invoke-virtual {p1, v0, v2}, Landroid/graphics/drawable/GradientDrawable;->setSize(II)V

    iget-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->g:Landroid/graphics/drawable/GradientDrawable;
    ...
    iget v4, p0, Lcom/android/camera/ui/DragLayoutBar;->s:F
    ...
    iput-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->h:Landroid/graphics/drawable/GradientDrawable;

    iget v2, p0, Lcom/android/camera/ui/DragLayoutBar;->k:F

    float-to-int v2, v2

    div-int/2addr v2, v1

    iget v4, p0, Lcom/android/camera/ui/DragLayoutBar;->j:F

    float-to-int v4, v4

    invoke-virtual {p1, v2, v4}, Landroid/graphics/drawable/GradientDrawable;->setSize(II)V

    iget-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->h:Landroid/graphics/drawable/GradientDrawable;
    ...
    iget v2, p0, Lcom/android/camera/ui/DragLayoutBar;->s:F
    ...
    iput-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->v2:Landroid/view/animation/Interpolator;
    ...
    iput-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->C8:Landroid/view/animation/Interpolator;
    ...
    iput-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->v1:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->v1:Landroid/animation/ValueAnimator;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Lcom/android/camera/ui/DragLayoutBar;->F8:Z
    ...
    iget-object v0, p0, Lcom/android/camera/ui/DragLayoutBar;->g:Landroid/graphics/drawable/GradientDrawable;
    ...
    iget-object v2, p0, Lcom/android/camera/ui/DragLayoutBar;->g:Landroid/graphics/drawable/GradientDrawable;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/DragLayoutBar;->h:Landroid/graphics/drawable/GradientDrawable;
    ...
    iget-object p0, p0, Lcom/android/camera/ui/DragLayoutBar;->h:Landroid/graphics/drawable/GradientDrawable;
...
.method public setFlatEnable(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/ui/DragLayoutBar;->G8:Z
...
.method public showWithAnim(Z)V
    ...
    new-instance p1, Ld/c/a/l5/i/c;

    const/4 v0, 0x0

    iget v1, p0, Lcom/android/camera/ui/DragLayoutBar;->w:F

    invoke-direct {p1, p0, v0, v1}, Ld/c/a/l5/i/c;-><init>(Landroid/view/View;FF)V
...
.method public start(I)Z
    ...
    iget-boolean v0, p0, Lcom/android/camera/ui/DragLayoutBar;->G8:Z
    ...
    :cond_0
    iget v0, p0, Lcom/android/camera/ui/DragLayoutBar;->E8:I
    ...
    :goto_1
    iput-boolean v0, p0, Lcom/android/camera/ui/DragLayoutBar;->F8:Z

    iget v0, p0, Lcom/android/camera/ui/DragLayoutBar;->D8:I
    ...
    :goto_2
    iput p1, p0, Lcom/android/camera/ui/DragLayoutBar;->E8:I

    iget-object v7, p0, Lcom/android/camera/ui/DragLayoutBar;->v1:Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/DragLayoutBar;->v1:Landroid/animation/ValueAnimator;
    ...
    :goto_3
    iget-object v6, p0, Lcom/android/camera/ui/DragLayoutBar;->v1:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->C8:Landroid/view/animation/Interpolator;

    goto :goto_5

    :cond_8
    iget-object p1, p0, Lcom/android/camera/ui/DragLayoutBar;->v2:Landroid/view/animation/Interpolator;
    ...
    iget v6, p0, Lcom/android/camera/ui/DragLayoutBar;->D8:I
    ...
    iget v6, p0, Lcom/android/camera/ui/DragLayoutBar;->E8:I
    ...
    iget-boolean v2, p0, Lcom/android/camera/ui/DragLayoutBar;->F8:Z
    ...
    iget-object p0, p0, Lcom/android/camera/ui/DragLayoutBar;->v1:Landroid/animation/ValueAnimator;
...
.method public updateBgColor()V
    ...
    iput v0, p0, Lcom/android/camera/ui/DragLayoutBar;->u:I
    ...
    iget v0, p0, Lcom/android/camera/ui/DragLayoutBar;->u:I

    invoke-static {v0}, Landroid/graphics/Color;->red(I)I

    move-result v0

    iget v1, p0, Lcom/android/camera/ui/DragLayoutBar;->u:I

    invoke-static {v1}, Landroid/graphics/Color;->green(I)I

    move-result v1

    iget v2, p0, Lcom/android/camera/ui/DragLayoutBar;->u:I
