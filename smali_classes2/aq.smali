...
.method public final b(Lap;)V
    ...
    invoke-virtual {v0}, Lba;->R0()Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Lba;->Q0()Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Lba;->S0()V
...
.method public final c(Landroid/os/Bundle;)Z
    ...
    invoke-interface {p0, p1, v2}, Las;->p([BLk;)V
    :try_end_0
...
.method public final d()V
    ...
    invoke-static {v6}, Leb;->n(Ljava/lang/Object;)V

    invoke-virtual {v2}, Lbu;->g()[B

    move-result-object v2

    invoke-interface {v6, v2}, Lg;->x([B)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/SecurityException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v1, v4}, Lba;->J0(I)V
