...
.method public final J0(I)V
    ...
    invoke-static {p1}, Lba;->L0(I)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {v0}, Lba;->L0(I)Z
    ...
    :cond_0
    invoke-static {p1}, Lba;->N0(I)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {v0}, Lba;->N0(I)Z
...
.method public final K0(Lg;)V
    ...
    invoke-virtual {p0, p1}, Lba;->J0(I)V
    ...
    :cond_3
    invoke-virtual {p1}, Lda;->F()V

    iput-boolean v4, p1, Lda;->c:Z

    :goto_1
    iget-object v3, p1, Lda;->b:Lde;
    ...
    invoke-virtual {v3}, Lde;->r()Lda;

    move-result-object v3

    check-cast v3, Lq;

    iget-boolean v5, v3, Lda;->c:Z
    ...
    iput-boolean v4, v3, Lda;->c:Z

    :goto_2
    iget-object v4, v3, Lda;->b:Lde;

    check-cast v4, Lr;

    invoke-static {v4}, Lr;->s(Lr;)V

    invoke-virtual {v3}, Lda;->J()Lde;

    move-result-object v3

    check-cast v3, Lr;

    invoke-virtual {p1, v2, v3}, Ldb;->S(Lcq;Ljava/lang/Object;)V

    invoke-virtual {p1}, Lda;->J()Lde;
    ...
    invoke-static {v2}, Leb;->n(Ljava/lang/Object;)V

    invoke-virtual {v0}, Lbu;->g()[B

    move-result-object v0

    invoke-interface {v2, v0}, Lg;->x([B)V

    iget-object v0, p0, Lba;->g:Lg;

    invoke-static {v0}, Leb;->n(Ljava/lang/Object;)V

    invoke-virtual {p1}, Lbu;->g()[B

    move-result-object p1

    invoke-interface {v0, p1}, Lg;->x([B)V
...
.method public final synthetic M0([BLk;)V
    .locals 4
    ...
    invoke-static {v0, p1, v1}, Lde;->j(Lde;[BLcs;)Lde;
    ...
    invoke-static {p2}, Lde;->p(Lcq;)Lcq;

    move-result-object p2

    invoke-virtual {p1, p2}, Ldc;->s(Lcq;)V
    ...
    invoke-virtual {p0, v2}, Lba;->J0(I)V
    :try_end_1
...
.method public final O0()V
    ...
    invoke-virtual {p0, v0}, Lba;->J0(I)V
...
.method public final S0()V
    ...
    invoke-virtual {p0}, Lba;->R0()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lba;->Q0()Z
...
.method public final a()V
    ...
    invoke-static {v3}, Lad;->s(Lad;)V

    invoke-virtual {v2}, Lda;->J()Lde;

    move-result-object v2

    check-cast v2, Lad;

    invoke-virtual {v0, v1, v2}, Ldb;->S(Lcq;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Leb;->n(Ljava/lang/Object;)V

    invoke-virtual {v0}, Lbu;->g()[B

    move-result-object v0

    invoke-interface {v1, v0}, Lg;->x([B)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final h()I
    ...
    invoke-static {v1, v0}, Leb;->p(ZLjava/lang/String;)V
...
.method public final p([BLk;)V
    ...
    invoke-static {p0}, Leb;->n(Ljava/lang/Object;)V

    invoke-interface {p0, p1, p2}, Lg;->c([BLk;)V
